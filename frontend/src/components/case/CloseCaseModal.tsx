// frontend/src/components/case/CloseCaseModal.tsx
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Para finalizar o caso, por favor, selecione o motivo e insira o parecer final.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            {errors.motivoDesligamento && (
              <p className="text-sm text-destructive">{errors.motivoDesligamento.message}</p>
            )}
          </div>
          <div className="space-y-2">
            ...
            />
            {errors.parecerFinal && (
              <p className="text-sm text-destructive">{errors.parecerFinal.message}</p>
            )}
          </div>
          <DialogFooter>
