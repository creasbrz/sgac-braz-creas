...
import { FileText, BarChart3, Users, ClipboardList } from 'lucide-react'
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <Tabs defaultValue="rma" value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <div className="flex justify-center md:justify-start">
          <TabsList className="grid w-full md:w-[600px] grid-cols-3 bg-muted/60 p-1 rounded-lg shadow-inner">
