...
interface RmaData {
  bloco1: {
    ...
    // C - Crianças
    c1_infamiliar: ChildCounter;
    c2_abuso: ChildCounter;
    c3_exploracao: ChildCounter;
      ...
      <style>{`
        @media print {
          ...
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          #rma-print-content, #rma-print-content * { visibility: visible; }
          #rma-print-content {
            position: absolute; top: 0; left: 50%;
            width: 210mm; transform: translateX(-50%) scale(0.85); 
            transform-origin: top center; margin: 0; padding: 0; background: white;
          }
      ...
      {data && (
        <div id="rma-print-content" className="w-[210mm] bg-white p-[10mm] shadow-2xl print:shadow-none print:w-full print:p-0 text-black leading-snug">
          ...
          <table className="w-full border-collapse border border-black border-t-0 break-inside-avoid">
            ...
            <tbody>
              {renderSimpleRow('A.1', 'Total de casos em acompanhamento (Ativos no mês)', data.bloco1.a1_total_acompanhamento)}
              ...
              {renderSimpleRow('B.3', 'Famílias com crianças/adolescentes em Trabalho Infantil', data.bloco1.b3_trabalho_infantil)}
          ...
          <div className="mt-4 border border-black break-inside-avoid">
            <table className="w-full border-collapse">
              <thead>
                ...
                <tr><Th>0 a 6</Th><Th>7 a 12</Th><Th>13 a 17</Th></tr>
              </thead>
              <tbody>
          ...
          <div className="mt-4 border border-black break-inside-avoid">
            <table className="w-full border-collapse">
              <thead>
                ...
                <tr><Th>0 a 12 anos</Th><Th>13 a 15 anos</Th></tr>
              </thead>
              <tbody>
                <tr>
                  <Td rS={2} align="left" className="w-[45%]"><span className="font-bold mr-1">C.5</span>Crianças/Adolescentes em Trabalho Infantil</Td>
                  <Td rS={2} className="font-bold bg-gray-100">{data.bloco1.c5_trabalho_infantil.total}</Td>
                  <Td className="text-[9px] font-bold uppercase bg-gray-100">Masc</Td>
                  <Td>{data.bloco1.c5_trabalho_infantil.masculino.a0_12}</Td><Td>{data.bloco1.c5_trabalho_infantil.masculino.a13_15}</Td>
                </tr>
                <tr>
                  <Td className="text-[9px] font-bold uppercase bg-gray-100">Fem</Td>
                  <Td>{data.bloco1.c5_trabalho_infantil.feminino.a0_12}</Td><Td>{data.bloco1.c5_trabalho_infantil.feminino.a13_15}</Td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <table className="w-full border-collapse border border-black border-t-0 mt-0 break-inside-avoid">
            <thead>
              {/* CORREÇÃO: Tabela agora possui apenas 2 colunas para combinar com as linhas geradas */}
              <tr>
                <DarkTh className="pl-2" align="left">Descrição do Atendimento</DarkTh>
